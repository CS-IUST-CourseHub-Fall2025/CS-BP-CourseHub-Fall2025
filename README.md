...
**Exams/** → Information about the exam format, past exam papers, and provided solutions
...
### 2️⃣ Folder Structure inside Branch
- Inside your branch, create **one folder per week/macro topic**
-  Place all your tasks for that week inside the corresponding folder.
- Each task folder must follow the **Task Template**.
### 3️⃣ Committing Files
- Commit often and with clear messages.
### 4️⃣ Pull Requests (PR)
- When your tasks are ready and tested:
1. Open a **Pull Request** to `main`.
2. QA Reviewer will review the PR.
3. After approval, merge into `main`.
- Always **do not merge your own branch without QA/Head TA approval**.
### 5️⃣ Guidelines for Edits
- Only modify files inside **your own folder and branch**.
- Do **not** edit other TA’s folders.
### 6️⃣ QA Feedback
